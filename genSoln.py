...
#################################################
# usage :python3 genSoln kt Lmax 
#        python3 genSoln 1 600   soluton at tau 
#        python3 genSoln 10 600   soluton at 10*tau 
#
tau = 1e-5 
kappa1= 2.3
kappa2= 2.5
...
print('min/max = ', min(randfield), max(randfield))
sv_fig = map_type + '_Lmax' + str(Lmax) + '_t_'+str(kt)+'tau_tau_1e_5.png'
plt.figure(1)
cm = cmbcmap()
#ti =r'Initial condition $u_L(0)$ ' + ', $L= %d$' %Lmax
#ti =r'Full solution $u_L(t)$ at $t=10\tau$, with ${\tau}=10^{-5}$ ' + ', $L= %d$' %Lmax
